...
const Questionnaire = () => {
  ...
  const handleInputChange = (event) => {
    ...
    const questionText = quiz2.questions[currentQuestionIndex].question;
  ...
  useEffect(() => {
    const currentQuestionText = quiz2.questions[currentQuestionIndex].question;
  ...
  const currentQuestion = quiz2.questions[currentQuestionIndex];
  const isLastQuestion = currentQuestionIndex === quiz2.questions.length - 1;
        ...
        <div className="m-auto w-11/12">
          {result ? (
            <>
              ...
              <h2 className="text-xl font-bold mb-3">Your Diabetes Diet Plan Is:</h2>
              <div
